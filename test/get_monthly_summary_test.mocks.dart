...
// in expense_tracker/test/get_monthly_summary_test.dart.
...
class MockTransactionRepository extends _i1.Mock
  ...
  @override
  _i3.Stream<List<_i4.Transaction>> watchTransactionsInMonth(DateTime? month) =>
      (super.noSuchMethod(
            Invocation.method(#watchTransactionsInMonth, [month]),
            returnValue: _i3.Stream<List<_i4.Transaction>>.empty(),
          )
          as _i3.Stream<List<_i4.Transaction>>);

  @override
  _i3.Stream<List<_i4.Transaction>> watchRecentTransactions({
    int? limit = 10,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Stream<List<_i4.Transaction>> watchAllTransactions() =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<List<_i5.TrendDataPoint>> getMonthlyTrend(int? months) =>
      (super.noSuchMethod(
            Invocation.method(#getMonthlyTrend, [months]),
            returnValue: _i3.Future<List<_i5.TrendDataPoint>>.value(
              <_i5.TrendDataPoint>[],
            ),
          )
  ...
  _i3.Future<void> addTransfer(
    _i4.Transaction? outgoing,
    _i4.Transaction? incoming, {
    String? source = 'user',
  }) =>
      (super.noSuchMethod(
            Invocation.method(
